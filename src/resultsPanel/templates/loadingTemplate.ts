 ...
 */
export function getLoadingHtml(extensionUri: vscode.Uri, headerHtml: string, startTime: number, autoCommitOnce: boolean): string {
        ...
        <body>
            ...
            <div class="executing-bar">
                ...
                <div style="display: flex; align-items: center; margin-right: 15px;">
                    ...
                    <label class="auto-commit-once" title="Commit automatically once after this query finishes">
                        <input type="checkbox" id="autoCommitOnce" ${autoCommitOnce ? 'checked' : ''}>
            ...
            <script>window.INITIAL_DATA = { startTime: ${startTime}, autoCommitOnce: ${autoCommitOnce} };</script>
