...
- **Query Results**: Context menu to copy values, columns (as raw values or as comma-separated list), or entire tables (Excel-formatted) to clipboard. Configurable panel location (side or bottom).
